...
| 11 — Automation | `../docs/superpowers/specs/2026-08-24-tasky-automation-design.md` | Signed off, **shipped to production** (`boards/automation.py`, `boards/models.py`, `boards/views.py`) |
